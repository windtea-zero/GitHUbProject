    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='blog_images/%Y/%m', verbose_name='博客配图')),
                ...
                ('author', models.ForeignKey(on_delete=models.SET(None), to=settings.AUTH_USER_MODEL, verbose_name='博客作者')),
